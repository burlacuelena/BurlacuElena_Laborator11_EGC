...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        public Form1() {
            ...
            animationTimer.Tick += (s, e) => AnimationScene();
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            GL.Rotate(rotationAngle, 0.0f, 1.0f, 0.0f); //rotam in jurul axei Y

            GL.Color4(1.0f, 0.0f, 0.0f, alphaValue);
            DeseneazaCubQ();
            if(isAlphaBlending)
            {
        ...
        {
            isRotating = !isRotating; // Comută starea rotației.
            btnRotate.Text = isRotating ? "Stop Rotation" : "Rotate"; // Actualizează textul butonului.
        }

        private void btnAlphaBlending_Click(object sender, EventArgs e)
        {
            isAlphaBlending = !isAlphaBlending;
            btnAlphaBlending.Text = isAlphaBlending ? "Alpha Blending ON" : "Alpha Blending OF";
            GlControl1.Invalidate();
        }
        ...
        private bool isAlphaBlending = false;
        private void AnimationScene()
        {
            if (isRotating) // Verifică dacă rotația este activată.
            {
                rotationAngle += 1.0f;
                ...
                GlControl1.Invalidate(); // Redesenare control OpenGL.
            }
        }
